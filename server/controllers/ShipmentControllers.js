...
const db = new sqlite.Database("../models/DevMedicos.db"); // Assuming `db` is your SQLite database instance
...
async function runQuery(query, params) {
    try {
        ...
        console.error("Error executing runQuery:", err.message);
    ...
    for (const shipment of shipments) {
        ...
        try {
            ...
            try {
                ...
                const preCheckResult = await promisifiedGet(preCheckQuery, [invoice_no, item]);
